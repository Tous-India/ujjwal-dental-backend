...
router.post("/", authProtect, checkPermission("reports", "create"), uploadMultiple("files", 10), reportController.uploadReport);

// Update report details - Admin
router.patch("/:id", authProtect, checkPermission("reports", "edit"), reportController.updateReport);

// Delete report (soft delete) - Admin
router.delete("/:id", authProtect, checkPermission("reports", "delete"), reportController.deleteReport);

// ==================== REPORT ACTIONS ====================

// Add tags to report - Admin
router.post("/:id/tags", authProtect, checkPermission("reports", "edit"), reportController.addTags);

// Toggle report visibility for patient - Admin
router.patch("/:id/visibility", authProtect, checkPermission("reports", "edit"), reportController.toggleVisibility);

// Replace report file - Admin
router.put("/:id/file", authProtect, checkPermission("reports", "edit"), uploadSingle("file"), reportController.replaceReportFile);
