...
router.post("/", authProtect, followUpController.createFollowUp);
router.patch("/:id", authProtect, followUpController.updateFollowUp);
router.patch("/:id/done", authProtect, followUpController.markFollowUpDone);
router.patch("/:id/cancel", authProtect, followUpController.cancelFollowUp);
